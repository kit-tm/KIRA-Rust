...
d3 = net.addDocker(name="d3", sysctls=SYSCTL, cap_add=['net_admin'], dimage="kira")
...
info(d1.cmd("./nodetopath.sh fc00::3 fcaa::2"))
info(d1.cmd("ip a add fc00::1/16 dev d1-eth0"))
info(d1.cmd("ip a add fcaa::1/16 dev d1-eth0"))

info(d2.cmd("./start.sh fc00::2"))
info(d2.cmd("./pathtopath.sh fcaa::2 fcaa::3"))
info(d2.cmd("./pathtopath.sh fcaa::4 fcaa::1"))
info(d2.cmd("ip a add fcaa::2/16 dev d2-eth0"))
info(d2.cmd("ip a add fcaa::4/16 dev d2-eth1"))

info(d3.cmd("./start.sh fc00::3"))
info(d3.cmd("./nodetopath.sh fc00::1 fcaa::4"))
info(d3.cmd("ip a add fc00::3/16 dev d3-eth0"))
info(d3.cmd("ip a add fcaa::3/16 dev d3-eth0"))
