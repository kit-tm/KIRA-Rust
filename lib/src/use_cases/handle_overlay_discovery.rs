...
mod tests {
    ...
    use crate::domain::{Contact, InsertionStrategyResult, Link, NetworkInterface, NodeId, NotVia, PNTable, Path, RoutingTable, StateSeqNr, TestInsertionStrategy, InMemoryPNTable};
